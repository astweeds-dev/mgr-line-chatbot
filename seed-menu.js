...
const MENU = [
  // 🍚 อาหาร
  { id: 1,  cat: "food", nameTh: "ไข่เจียว", nameEn: "Thai Omelette", price: { default: 50 }, addons: [{ id: "หมูสับ", price: 10 }, { id: "พิเศษ", price: 20 }], level: [], levelLabel: "", variantLabel: "" },
  { id: 3,  cat: "food", nameTh: "ผัดกะเพรา", nameEn: "Stir-fried Basil", price: { "หมู": 70, "เนื้อ": 80 }, addons: [], level: SPICINESS, levelLabel: "ระดับความเผ็ด", variantLabel: "" },
  { id: 4,  cat: "food", nameTh: "ผัดน้ำมันหอย", nameEn: "Stir-fried Oyster Sauce", price: { "หมู": 70, "เนื้อ": 80 }, addons: [], level: SPICINESS, levelLabel: "ระดับความเผ็ด", variantLabel: "" },
  { id: 5,  cat: "food", nameTh: "ผัดเต้าเจี้ยว", nameEn: "Stir-fried Bean Paste", price: { "หมู": 70, "เนื้อ": 80 }, addons: [], level: SPICINESS, levelLabel: "ระดับความเผ็ด", variantLabel: "" },
  { id: 6,  cat: "food", nameTh: "ผัดพริกเผา", nameEn: "Stir-fried Roasted Chili Paste", price: { "หมู": 70, "เนื้อ": 80 }, addons: [], level: SPICINESS, levelLabel: "ระดับความเผ็ด", variantLabel: "" },
  { id: 7,  cat: "food", nameTh: "ผัดพริกแกง", nameEn: "Stir-fried Curry Paste", price: { "หมู": 70, "เนื้อ": 80 }, addons: [], level: SPICINESS, levelLabel: "ระดับความเผ็ด", variantLabel: "" },
  { id: 8,  cat: "food", nameTh: "ผัดกระเทียม", nameEn: "Stir-fried Garlic", price: { "หมู": 70, "เนื้อ": 80 }, addons: [], level: SPICINESS, levelLabel: "ระดับความเผ็ด", variantLabel: "" },
  { id: 9,  cat: "food", nameTh: "พะแนง", nameEn: "Panang Curry", price: { "หมู": 80, "เนื้อ": 90 }, addons: [], level: SPICINESS, levelLabel: "ระดับความเผ็ด", variantLabel: "" },
  { id: 10, cat: "food", nameTh: "พริกแกงใต้", nameEn: "Southern Curry", price: { "หมู": 80, "เนื้อ": 90 }, addons: [], level: SPICINESS, levelLabel: "ระดับความเผ็ด", variantLabel: "" },
  { id: 11, cat: "food", nameTh: "พริกเกลือ", nameEn: "Salt Chili Stir-fry", price: { "หมู": 80, "เนื้อ": 90 }, addons: [], level: SPICINESS, levelLabel: "ระดับความเผ็ด", variantLabel: "" },
  { id: 12, cat: "food", nameTh: "ผัดไข่เค็ม", nameEn: "Stir-fried Salted Egg", price: { "หมู": 90, "เนื้อ": 100 }, addons: [], level: SPICINESS, levelLabel: "ระดับความเผ็ด", variantLabel: "" },
  { id: 13, cat: "food", nameTh: "เขียวหวาน", nameEn: "Green Curry", price: { "หมู": 90, "เนื้อ": 100 }, addons: [], level: SPICINESS, levelLabel: "ระดับความเผ็ด", variantLabel: "" },
  { id: 14, cat: "food", nameTh: "หมูสับไข่ระเบิด", nameEn: "Minced Pork & Runny Egg", price: { default: 90 }, addons: [], level: SPICINESS, levelLabel: "ระดับความเผ็ด", variantLabel: "" },
  { id: 15, cat: "food", nameTh: "ผัดผงกะหรี่", nameEn: "Stir-fried Curry Powder", price: { "หมู": 90, "เนื้อ": 100 }, addons: [], level: SPICINESS, levelLabel: "ระดับความเผ็ด", variantLabel: "" },
